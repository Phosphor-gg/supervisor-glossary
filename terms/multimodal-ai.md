...
- A meme where the image is harmless and the caption is harmless, but together they form a targeted insult or [hate](/glossary/hate-speech).
- An otherwise clean message attached to explicit or violent imagery.
- A screenshot used to [dox](/glossary/doxxing) someone, where the sensitive detail is in the picture, not the text.
