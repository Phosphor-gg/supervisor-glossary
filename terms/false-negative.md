...
Every false negative is a piece of real harm that reached its target. Too many of them mean the moderation system is not actually protecting the community, no matter how quiet the logs look. Catching the subtle cases is exactly where [implicit moderation](/glossary/implicit-moderation) matters most, because the abuse that evades detection is rarely the obvious kind. Measuring false negatives is done through recall, one half of [precision and recall](/glossary/precision-and-recall).
